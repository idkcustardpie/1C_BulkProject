/****************************************************************************
** Meta object code from reading C++ file 'admin_conversion.h'
**
...
#error "The header file 'admin_conversion.h' doesn't include <QObject>."
...
static constexpr auto qt_meta_stringdata_CLASSConversionENDCLASS = QtMocHelpers::stringData(
    "Conversion",
    "on_back_clicked",
    "",
    "on_clear_clicked",
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSConversionENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSConversionENDCLASS_t qt_meta_stringdata_CLASSConversionENDCLASS = {
    {
        QT_MOC_LITERAL(0, 10),  // "Conversion"
        QT_MOC_LITERAL(11, 15),  // "on_back_clicked"
        QT_MOC_LITERAL(27, 0),  // ""
        QT_MOC_LITERAL(28, 16),  // "on_clear_clicked"
        QT_MOC_LITERAL(45, 19),  // "on_generate_clicked"
        QT_MOC_LITERAL(65, 17)   // "on_back_2_clicked"
    },
    "Conversion",
    "on_back_clicked",
    "",
