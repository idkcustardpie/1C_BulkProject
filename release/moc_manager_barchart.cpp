/****************************************************************************
** Meta object code from reading C++ file 'manager_barchart.h'
**
...
#error "The header file 'manager_barchart.h' doesn't include <QObject>."
...
static constexpr auto qt_meta_stringdata_CLASSBarChartENDCLASS = QtMocHelpers::stringData(
    "BarChart",
    "on_signout_clicked",
    ""
);
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSBarChartENDCLASS_t qt_meta_stringdata_CLASSBarChartENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(9, 18),  // "on_signout_clicked"
        QT_MOC_LITERAL(28, 0)   // ""
    },
    "BarChart",
    "on_signout_clicked",
